...
export function post(overrides: Partial<FeedPost> = {}): FeedPost {
  return {
    ...
    attention: { at: "2026-09-10T09:00:00Z", basis: "evidence" },
  ...
  return {
    posts: [
      ...
      post({
        ...
        attention: { at: "2026-09-11T09:00:00Z", basis: "question" },
        score: 0,
        support: 0,
        oppose: 0,
        unsure: 0,
    ...
    ordering: "Next: desk urgency fades from independent-source citations or explicit acts.",
    notice: "",
    ...overrides,
  };
}

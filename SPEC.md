...
- add per-instance database-role revocation wherever a provider permits creating database users, payload-key rotation, coordinated PostgreSQL/Cellar/key backup and restore drills, and monitoring;

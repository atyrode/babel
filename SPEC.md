...
- Document and exercise coordinated PostgreSQL catalog backup, repository recovery, restic repository password custody and backup, storage configuration recovery, one-time repository creation, manual primary-host bootstrap, hourly timer enablement, and rollback to the still-enabled legacy backup.
